...
// context.fillRect(x,90,80,100);
// x+=3;
// }
// drawIt(); هذي يرسم مثلث و يتحرك من نفسه
...
class Player {
  ...
  draw() {
    c.strokeStyle = "blue" // الحدود
    c.fillStyle = "pink" //التعبئه
    c.fillRect(25, 25, 120, 80)
    c.strokeRect(25, 25, 120, 80)
  }
}
